--TEST--
Ingres: Adjust the date format to MDY and retrieve a date value.
--SKIPIF--
...
$options = array( "timezone" => "gmt", "date_format" => INGRES_DATE_MDY );
...
?>
--EXPECT--
Connection succeeded.sep-06-2005 12:00:00
