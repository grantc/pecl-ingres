--TEST--
Ingres: Adjust the date format to YMD and retrieve a date value.
--SKIPIF--
...
$options = array( "timezone" => "gmt", "date_format" => INGRES_DATE_YMD );
...
?>
--EXPECT--
Connection succeeded.2005-sep-06 12:00:00
